...
console.log(`Frame 0: https://apiradio.varnaamedicalbillingsolutions.com/api/dicom/studies/${studyUID}/frames/0`);
console.log(`Frame 1: https://apiradio.varnaamedicalbillingsolutions.com/api/dicom/studies/${studyUID}/frames/1`);
console.log(`Frame 2: https://apiradio.varnaamedicalbillingsolutions.com/api/dicom/studies/${studyUID}/frames/2`);
console.log('');
