...
export class ImageLoader {
  ...
  createImageId(options: ImageLoadOptions): string {
    ...
    let imageId = `wadouri:/api/dicom/studies/${studyInstanceUID}/series/${seriesInstanceUID}/instances/${sopInstanceUID}`
  ...
  private async getSeriesInstanceUIDs(
    ...
    try {
      ...
      const response = await fetch(
        `/api/dicom/studies/${studyInstanceUID}/series/${seriesInstanceUID}/instances`
      )
